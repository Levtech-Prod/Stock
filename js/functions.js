...
APP.showDlg = function(title, message, yepp_btntext, nope_btntext, yeppCallback, nopeCallback, icon){
    title = ((typeof title !== 'undefined') && title) ? title : '';
    message = ((typeof message !== 'undefined') && message) ? message : '';
    ...
    var $container = $("<div></div>").html('<p><i class="'+icon+'" style="color:#3B81CD;font-size:2em;position:absolute;"></i><label style="padding-left:2.5em;line-height:2em;">'+message+'</label></p>');
    var tmp_z = '99';
    $('body').append($container);
    $container.dialog({
        title:title,
