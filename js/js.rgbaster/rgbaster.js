;(function(window, undefined){
  ...
  var getImageData = function(img, loaded){
	if (img.canvas){//if it's already a canvas
		  //console.log(img.canvas.width+'x'+img.canvas.height);
		  var imageData = img.getImageData(0, 0, img.canvas.width, img.canvas.height);
