...
*
*/
class Project_status_Model extends MY_CRUDModel{

    var $validate_field_existence = TRUE;

    var $primary_table = 'project_status';
    ...
    public function xsel2_project_status(){
    ...
    public function order_element($id, $direction = 'up'){
        ...
        if (isset($id) && (in_array($direction, array('up','down')))){
            $sql = "call cli_order_generic('project_status',?,?,'sort','','','')";
