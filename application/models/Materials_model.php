...
*
*/
class Materials_Model extends MY_CRUDModel{

    var $validate_field_existence = TRUE;

    var $primary_table = 'materials';
    ...
    public function xsel2_materials(){
        $searchTerm = request('q');
        $where_like = $this->build_where_like($searchTerm, array('name', 'code'));
        $sql = "SELECT id, concat(name, ' - ', code) as name, code, density, price
                FROM materials
