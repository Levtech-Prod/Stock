...
class Jobs extends MY_Controller {
    ...
    public function get_job(){
        ...
        $sql = "SELECT j.*, o.id as order_id, o.name as order_name, concat(m.name, ' - ', m.code) as material_name, js.name as status_name, js.colour, js.`type`, concat('".profile_to_url(UPLOAD_IMG_DIR)."', j.image) as image_url, j.working_minutes, c.alias
                from jobs j
